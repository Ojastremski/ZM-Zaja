...
* Fix - better session handling on some configurations
...
* Fix - pagination on main product listing page with shortcode integration

= 2.7.21 - 08/02/2018 =

* Fix - multiple titles on category page on some themes
...
* Fix - product page not displaying properly on some configurations

= 2.7.18 - 29/01/2018 =

* Tweak - show admin notices only on catalog admin pages
* Tweak - better page builders support for eCommerce pages
