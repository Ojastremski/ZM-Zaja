(function($, window, document, undefined) {
            ...
            this.jqElem.on('transitionend webkitTransitionEnd oTransitionEnd otransitionend MSTransitionEnd',
                function() {
                    if (pluginThis.inTransition) {
                        ...
                        setTimeout(function() { pluginThis.doCommandQueue();}, 50);
                    }
                });
        } else {
    ...
    Plugin.prototype.setItem = function(n, right_or_left) {
        ...
        for (var i = 0; i < sliderItems.length; i++) {
            ...
            if (i == n) {
                ...
                if (right_or_left == 'image_to_right') {
                    item.find('img').removeClass().addClass("image_to_right");
                } else {
                    item.find('img').removeClass().addClass("image_to_left");
                }
            } else if (i < n) {
        ...
        if (supportsTransitions && this.options.useTransitions) {
    ...
    Plugin.prototype.nextItem = function() {
        ...
        if (this.options.infiniteScroll || this.currentItem < this.numSliderItems - 1) {
            ...
            this.setItem(this.currentItem, 'image_to_right');
    ...
    Plugin.prototype._wrapIndex = function(n) {
        ...
        //uwaga: zakładamy, że te indeksy nie stają się zbyt szalone poza granicami.
